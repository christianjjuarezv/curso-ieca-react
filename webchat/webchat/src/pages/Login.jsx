...
const Login = () => {
    ...
    return (
        <div className="flex flex-col w-full h-full items-center">
            <div className="flex flex-col items-center justify-center w-fit h-fit bg-indigo-950 rounded-md p-8">
                <h1 className="text-2xl font-bold text-indigo-50">Iniciar sesión</h1>
                <form className="flex flex-col w-full mt-4 text-slate-900" onSubmit={handleSubmit}>
                    ...
                    <input 
                        ...
                        onChange={handleChange}
                        />
                    <button type="submit" className="w-full p-2 mt-4 bg-cyan-500 text-white rounded-md hover:bg-cyan-700">Iniciar sesión</button>
